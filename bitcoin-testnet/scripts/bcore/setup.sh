...
sudo mkdir /var/lib/bitcoin/testnet3
...
sudo ln -s /var/lib/bitcoin/testnet3/debug.log /var/log/bitcoin/debug.log
sudo ln -s /var/lib/bitcoin/testnet3/db.log /var/log/bitcoin/db.log
sudo touch /var/lib/bitcoin/testnet3/debug.log
sudo touch /var/lib/bitcoin/testnet3/db.log
